...
// ERD alogrithm
// Products to Orders is a one-to-many relationship because each product id in the Products entity (PK) can be associated with multiple orders, but each product id within the Orders entity can only be associated with one product in the Products entity.
// Employees to Orders is a one-to-many relationship beause the employee id in the Employees entity (PK) can be associated with multiple orders, but the employee id within the Orders entity can only be associated with one employee in the Employees entity.
// Therefore the Orders entity is the bridge table and the relationship between the Orders entity and the Employees entity is many-to-many.